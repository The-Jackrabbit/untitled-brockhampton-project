...
class Album extends Component {
	...
	componentDidMount() {
		...
		var _this = this;
		axios.get(`http://localhost:7001/api/albums/${albumPK}/detail`)
		.then(function(res){
	...
	render() {
		return (
			<div>
				...
				<div className="album-bg-container" style={{"backgroundImage": `url(http://localhost:7001${this.state.bgImg})`}}></div>
			</div>	
		);
	}
}
