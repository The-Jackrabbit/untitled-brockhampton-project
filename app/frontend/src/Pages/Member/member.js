...
class Member extends Component {
	...
	componentWillMount() {
		...
		// GET PROFILE PIC
		axios.get(`http://localhost:7001/api/person/pics/?size=lg&name=${personArg}`)
		.then(function(res){
			_this.setState({
		...
		axios.get(`http://localhost:7001/api/person/words/?name=${personArg}&minLength=5&n=15`)
		.then(function(res){
		...
		// GET SONG PART STATS
		axios.get(`http://localhost:7001/api/memberPage/?name=${personArg}`)
		.then(function(res){
			_this.setState({
